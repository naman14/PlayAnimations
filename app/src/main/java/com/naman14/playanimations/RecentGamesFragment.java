...
import com.naman14.playanimations.adapter.RecentGamesAdapter;
...
public class RecentGamesFragment extends Fragment {
    ...
    private RecentGamesAdapter mAdapter;
    ...
    private void setUpGameList() {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            game.setCover(R.drawable.zombie_cover);

            gamesList.add(game);
        }

        mAdapter = new RecentGamesAdapter(getActivity(), gamesList);
